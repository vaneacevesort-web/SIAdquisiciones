...
async function main() {
  ...
  try {
    ...
    const subcapitulos = [
      ['9000', '9100', 'Amortización de la Deuda Pública'],
      ['9000', '9200', 'Intereses de la Deuda Pública'],
      ['9000', '9300', 'Comisiones de la Deuda Pública'],
      ['9000', '9400', 'Gastos de la Deuda Pública'],
      ['9000', '9500', 'Costo por Coberturas'],
      ['9000', '9600', 'Apoyos Financieros'],
      ['9000', '9900', 'Adeudos de Ejercicios Fiscales Anteriores (ADEFAS)']
    ];
    ...
    console.log('Subcapítulos 9000 procesados =>', procesados);
  } catch (error) {
    console.error('Error al importar subcapítulos 9000:', error);
  } finally {
