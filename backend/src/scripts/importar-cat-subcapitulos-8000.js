...
async function main() {
  ...
  try {
    ...
    const subcapitulos = [
      ['8000', '8100', 'Participaciones'],
      ['8000', '8300', 'Aportaciones'],
      ['8000', '8500', 'Convenios']
    ];
    ...
    console.log('Subcapítulos 8000 procesados =>', procesados);
  } catch (error) {
    console.error('Error al importar subcapítulos 8000:', error);
  } finally {
