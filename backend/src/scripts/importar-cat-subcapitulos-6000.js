...
async function main() {
  ...
  try {
    ...
    const subcapitulos = [
      ['6000', '6100', 'Obra Pública en Bienes de Dominio Público'],
      ['6000', '6200', 'Obra Pública en Bienes Propios'],
      ['6000', '6300', 'Proyectos Productivos y Acciones de Fomento']
    ];
    ...
    console.log('Subcapítulos 6000 procesados =>', procesados);
  } catch (error) {
    console.error('Error al importar subcapítulos 6000:', error);
  } finally {
